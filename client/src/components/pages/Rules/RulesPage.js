      ...
      <>
        ...
        <EmpCard title="Magic" noSpacing>
          <div className={card}>
            ...
            <p>
              Arcane spells require an arcane focus, such as a staff or wand. Arcane magic comes from the physical forces that tie the world together, and arcane spells are cast by understanding and manipulating these forces. Divine spells require a divine focus, such as a holy symbol or totem. Divine magic comes from the powerful beings that shaped and organized the primal forces of creation, and divine spells are cast by working with or harnessing the powers of these beings. Unity spells require a unity focus, such as an instrument or a trinket. Unity magic comes from the bonds between sentient beings, and unity spells are cast by manipulating these bonds to one’s own ends.
            </p>
            <p>
              Some features, especially spells, require reagents, which are special items that you must have in your inventory to use the feature. Sometimes, the feature will consume the reagent, which means you must have a copy of the reagent for each time you wish to use the feature. The reagent must be on your person, and you cannot use the feature without the reagent.
            </p>
            <p>
